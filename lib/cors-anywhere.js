...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    if (!origin.match(/^https:\/\/nex3-[^.]+\.githubpreview\.dev$/) &&
        !origin.match(/^https:\/\/nex3-[^.]+\.preview\.app\.github\.dev$/) &&
        !origin.match(/^https:\/\/nex3.github.io$/) &&
        !origin.match(/^https:\/\/nex-3.com$/) &&
        !origin.match(/^http:\/\/localhost:\d+/)) {
      res.writeHead(403, 'Forbidden', cors_headers);
      res.end('The origin "' + origin + '" was not allowed by the operator of this proxy.');
      return;
    }
